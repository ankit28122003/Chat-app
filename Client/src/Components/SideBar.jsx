            ...
            <div className='pb-5 '>
                <div className='flex justify-between items-center '>
                    ...
                    <div className='relative py-2 group '>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md  border border-gray-600 text-gray-100 hidden group-hover:block backdrop-blur-2xl bg-blue-300' >
